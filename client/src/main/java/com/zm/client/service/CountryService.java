...
public class CountryService {
    ...
    // CountryList httpResponse = restTemplate.getForObject(COUNTRIES_LIST_API_URL,
    // CountryList.class);
    ...
    // List<Country> countries = objectMapper.readValue(responseBody, new
    ...
    // entity, String.class);
    // String responseBody = response.getBody();
    // List<GeoData> geoData = objectMapper.readValue(responseBody, new
    // TypeReference<List<GeoData>>() {
    // });
    ...
    // String url = String.format(WEATHER_API_URL, geoData.getLatitude(),
